...
def decrypt():
    ...
    if selected_algorithm == "Base64":
        ...
        decrypted_message = aes_decrypt(message, b'1g2OabaDu6GuSMfqlkTdXjYxlVThEDT-ip8oqN7D1yI=')
...
def main_screen():
    ...
    Label(text="Enter AES key (32-byte):", fg="black", font=("calibri", 13)).place(x=10, y=290)
    aes_key_entry = Entry(width=19, bd=1, font=("arial", 14))
    aes_key_entry.place(x=200, y=290)

    Label(text="Enter DES key (8-byte):", fg="black", font=("calibri", 13)).place(x=10, y=320)
    des_key_entry = Entry(width=19, bd=1, font=("arial", 14))
    des_key_entry.place(x=200, y=320)

    Button(text="ENCRYPT", height="2", width=23, bg="#ed3833", fg="white", bd=0, command=encrypt).place(x=10, y=350)
    Button(text="DECRYPT", height="2", width=23, bg="#00bd56", fg="white", bd=0, command=decrypt).place(x=200, y=350)
    Button(text="RESET", height="2", width=50, bg="#1089ff", fg="white", bd=0, command=reset).place(x=10, y=390)
